...
public class $3_minNumber {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------------");
        System.out.println(minNumber(doubleArray));
        System.out.println("--------------------");
        System.out.println(minNumber(longArray));
        System.out.println("--------------------");
        System.out.println(minNumber(shortArray));
        System.out.println("--------------------");
        System.out.println(minNumber(floatArray));
        System.out.println("--------------------");
        System.out.println(minNumber(byteArray));
